...
namespace IValidatableObjSSV.Models
{
    public class ApptRequest : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            else
            {
                ...
                {
                    errors.Add(new ValidationResult("You cannot book appointments on the weekend", new[] {"Date"}));
                }
            }
